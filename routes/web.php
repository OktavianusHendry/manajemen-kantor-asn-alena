...
Route::get('surat-keluar/{id}/pdf-asn', [SuratKeluarNewController::class, 'exportPDFASN'])->name('surat-keluar.exportPDF-ASN'); // Rute untuk mengunduh surat dalam format PDF ASN
Route::get('surat-keluar/{id}/pdf-aa', [SuratKeluarNewController::class, 'exportPDFAA'])->name('surat-keluar.exportPDF-AA'); // Rute untuk mengunduh surat dalam format PDF AA
