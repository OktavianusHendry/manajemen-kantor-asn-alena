                                ...
                                <p>
                                    ...
                                    @if (Auth::user()->role_as == '1' || Auth::user()->role_as == '2')
                                        @if ($surat->status_validasi == 'Disetujui') <!-- Ganti dengan status yang sesuai -->
                                            <a href="{{ route('surat-keluar.pdf-asn', $surat->id_surat) }}" class="btn btn-success">Format ASN</a>
                                            <a href="{{ route('surat-keluar.pdf-aa', $surat->id_surat) }}" class="btn btn-success">Format AA</a>
                                        @endif
                                    @endif
                                </p>
                            </div>
