                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action-buttons">
                                                        ...
                                                        @if ($surat_keluar->status_validasi == 'Disetujui')
                                                            <a href="{{ route('surat_keluar.exportPDF', $surat_keluar->id_surat) }}" class="btn btn-primary btn-sm">Unduh Surat</a>
                                                            
                                                            <form method="POST" action="{{ route('surat_keluar.validasi', $surat_keluar->id_surat) }}" style="display:inline;">
                                                                @csrf
                                                                @method('PUT')
                                                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Anda yakin ingin membatalkan validasi surat ini?')">
                                                                    Batalkan Validasi
                                                                </button>
                                                            </form>
                                                        @else
                                                            <form method="POST" action="{{ route('surat_keluar.destroy', $surat_keluar->id_surat) }}" style="display:inline;">
                                                                @csrf
                                                                @method('DELETE')
                                                            ...
                                                            <form method="POST" action="{{ route('surat_keluar.validasi', $surat_keluar->id_surat) }}" style="display:inline;">
                                                                @csrf
                                                                @method('PUT')
                                                                <button type="submit" class="btn btn-primary btn-sm" onclick="return confirm('Apakah Anda yakin ingin memvalidasi surat ini?')">
                                                                    Validasi
                                                                </button>
                                                            </form>
                                                        @endif
