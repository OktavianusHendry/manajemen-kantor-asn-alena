                        ...
                        <div class="col-xl">
                            <div class="card mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h2 style="font-size: 2.0em;"><b>Tambah Jenis Cuti Baru</b></h2>
                                </div>
                                ...
                                <form action="{{ route('jenis_cuti.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group mb-3">
                                            <label class="form-label" for="nama_jenis_cuti">Nama Jenis Cuti</label>
                                            <input type="text" name="nama_jenis_cuti" id="nama_jenis_cuti"
                                                placeholder="Masukkan Nama jenis cuti" class="form-control"
                                                value="{{ old('nama_jenis_cuti') }}" required>
                                        </div>
