            ...
            <main class="py-4">
                <div class="d-flex justify-content-between mb-2">
                    <h2 class="fw-bold py-3 mb-1">
                        <b>Data Sekolah</b>
                        <span class="text-muted fw-light">/ Manajemen Data Sekolah</span>
                    </h2>
                </div>
                <div class="card mb-4">
                    <div class="container">
                        ...
                        <form action="{{ route('sekolah.index') }}" method="GET" class="mb-3">
                            <div class="form-group d-flex">
                                <input type="text" name="search" value="{{ request()->input('search') }}"
                                    class="form-control" placeholder="Cari sekolah...">
                        ...
                        @if ($sekolas->count() > 0)
                                    ...
                                    <tbody class="table-border-bottom-0 align-content-center">
                                        @foreach ($sekolas as $sekolah)
                                            <tr>
                                                ...
                                                <td><i class="fab fa-angular fa-lg text-danger me-3"></i>
                                                    <strong>{{ $sekolah->alamat_sekolah }}</strong>
                                                </td>
                                                <td>
                                                    <a href="{{ route('sekolah.show', $sekolah->id_sekolah) }}"
                                                    ...
                                                    <form action="{{ route('sekolah.destroy', $sekolah->id_sekolah) }}"
                            ...
                            <div class="d-flex justify-content-center my-4 pagination-wrapper">
                                {{ $sekolas->appends(['search' => request()->input('search')])->links('pagination::bootstrap-4') }}
                            </div>
                        @else
